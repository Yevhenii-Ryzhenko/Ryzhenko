...
class TestValidationPasswordInput:
    ...
    @allure.story('Different passwords')
    def test_create_user_with_different_password(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
    ...
    @allure.story('Password without minimum security requirements')
    def test_create_user_with_password_only_small_letters(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
    ...
    @allure.story('Password without minimum security requirements')
    def test_create_user_with_password_only_capital_letters(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
                                             password="TEST1PASS", repeat_password="TEST1PASS")
    ...
    @allure.story('Password without minimum security requirements')
    def test_create_user_with_password_only_integer(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
    ...
    @allure.story('Length of password')
    def test_create_user_with_password_less_8_characters(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
                                             password="Test123", repeat_password="Test123")
    ...
    @allure.story('Length of password')
    def test_create_user_with_password_more_15_characters(self, driver, url, home_page, actions):
        register = RegistrationWindow(driver, url, home_page)
        register.enter_all_data(name=data.name, last_name=data.last_name,
                                             email=data.email,
